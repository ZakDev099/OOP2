...
fun main() {
    ...
    println("\n\n>>> Classes.Card #1 is used to play Classes.Game #1 5 times...")
    repeat(5) {
        game1.play(card1) // play game1 5 times with card1
    }
    println("\n\n>>> Classes.Card #2 is used to play Classes.Game #2 5 times...")
    repeat(5) {
        game2.play(card2) // play game1 5 times with card2
    }
    println("\n\n>>> Credits & Tickets will be transferred from Classes.Card #1 to Car #2...")
